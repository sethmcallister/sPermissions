...
public class AddSubGroupCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (args.length != 2) {
            sender.sendMessage(ChatColor.RED + "Usage: /addsubgroup <player> <group>");
            return true;
        }
        ...
        permissionsUser.getSubGroups().add(group.getName());
        ...
        if (target.isOnline()) {
            ...
            playerTarget.sendMessage(ChatColor.YELLOW + "You have been added to the sub group '" + ChatColor.GREEN + group.getName() + ChatColor.YELLOW + "'.");
